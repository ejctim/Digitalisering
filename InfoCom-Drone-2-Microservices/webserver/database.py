...
def moveDrone(d_long, d_la):
    la = float(redis_server.get('latitude').decode('utf-8'))
    lo = float(redis_server.get('longitude').decode('utf-8'))
    redis_server.set('longitude',(lo + d_long))
    redis_server.set('latitude',(la + d_la))
    pass
# ===============================================
